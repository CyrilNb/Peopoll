...
/* DROP TABLE POLLS,CHOICES,COMMENTS,CONTRIBUTIONS; */

CREATE TABLE IF NOT EXISTS peopoll.POLLS (
  id_poll INT NOT NULL CONSTRAINT pk_polls PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.CHOICES(
  id_choice INT NOT NULL CONSTRAINT pk_choices PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.COMMENTS(
  id_comment INT NOT NULL CONSTRAINT pk_comments PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.CONTRIBUTIONS(
  id_contribution INT NOT NULL CONSTRAINT pk_contributions PRIMARY KEY,
