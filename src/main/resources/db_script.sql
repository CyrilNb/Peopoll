...
CREATE TABLE IF NOT EXISTS peopoll.POLLS (
  id_poll INT NOT NULL AUTO_INCREMENT CONSTRAINT pk_polls PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.CHOICES(
  id_choice INT NOT NULL AUTO_INCREMENT CONSTRAINT pk_choices PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.COMMENTS(
  id_comment INT NOT NULL AUTO_INCREMENT CONSTRAINT pk_comments PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS peopoll.CONTRIBUTIONS(
  id_contribution INT NOT NULL AUTO_INCREMENT CONSTRAINT pk_contributions PRIMARY KEY,
